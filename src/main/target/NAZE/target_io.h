...
typedef enum {
    IO_NONE = 0,
    IO1, IO2, IO3, IO4, IO5, IO6, IO7, IO8, IO9, IO120, IO11, IO12, IO13, IO14, IO15, IO16, IO_BARO_XCLR, IO_BARO_EOC, IO_MPU6050_INT
} IOId_t;

#define IO_B13 IO_NONE
#define IO_C13 IO_NONE
