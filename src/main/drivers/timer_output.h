...
#define TIMEROUT_INVERTED      0x0200          // output is inverte
...
void timerOut_Config(timerOutputRec_t *self, const timerHardware_t *timHw, callbackRec_t *callback, uint16_t tim_OCPolarity);
