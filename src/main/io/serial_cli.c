...
const clicmd_t cmdTable[] = {
    ...
    CLI_COMMAND_DEF("save", "save and reboot", "[noreboot]", cliSave),
    CLI_COMMAND_DEF("serial", "configure serial ports", NULL, cliSerial),
#ifdef USE_SERVOS
    CLI_COMMAND_DEF("servo", "configure servos", NULL, cliServo),
#endif
    CLI_COMMAND_DEF("passtrough", "Setuop passthrough to serial port",
                    "<id> [baud [mode]] : passthrough to serial", cliPassthrough),
...
const clivalue_t valueTable[] = {
    { "loopticks",                  VAR_UINT8  | MASTER_VALUE,  &masterConfig.loopTicks, .config.minmax = { 0, 10 } },
    ...
    { "telemetry_inversion",        VAR_UINT8  | MASTER_VALUE,  &masterConfig.telemetryConfig.telemetry_mode, .config.minmax = { 0, 0xff } },
...
static void cliSerial(char *cmdline)
{
    ...
    for (i = 0; i < 4; i ++) {
        ...
        switch(i) {
            case 0:
                if (baudRateIndex < BAUD_9600 || baudRateIndex > BAUD_460800) {
                    continue;
                }
            ...
            case 2:
                ...
                break;
            case 3:
                if (baudRateIndex < BAUD_19200 || baudRateIndex > BAUD_460800) {
                    continue;
                }
