...
#define SOFTSERIAL_1_TIMER TIM4
#define SOFTSERIAL_1_TIMER_RX_HARDWARE 11
#define SOFTSERIAL_1_TIMER_TX_HARDWARE 10
#define SOFTSERIAL_2_TIMER TIM4
#define SOFTSERIAL_2_TIMER_RX_HARDWARE 12
#define SOFTSERIAL_2_TIMER_TX_HARDWARE 13
#endif
