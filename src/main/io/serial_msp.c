...
static serialPortMode_t mspPortConfig = { .mode = MODE_RXTX | MODE_DEFAULT_FAST };
...
void mspAllocateSerialPorts(serialConfig_t *serialConfig)
{
    ...
    while (portConfig && portIndex < MAX_MSP_PORT_COUNT) {
        ...
        mspPortConfig.baudRate =  baudRates[portConfig->msp_baudrateIndex];
        serialPort = openSerialPort(portConfig->identifier, FUNCTION_MSP, &mspPortConfig);
        if (serialPort) {
...
STATIC_UNIT_TESTED void mspProcessReceivedCommand(void) {
