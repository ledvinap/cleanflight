...
VALID_TARGETS	 = NAZE NAZE32PRO OLIMEXINO STM32F3DISCOVERY CHEBUZZF3 CC3D CJMCU EUSTM32F103RC SPRACINGF3 PORT103R SPARKY CRAZYFLIE ALIENWIIF1 ALIENWIIF3 COLIBRI_RACE
...
HIGHEND_SRC  =     flight/autotune_relay.c \
		   flight/navigation.c \
